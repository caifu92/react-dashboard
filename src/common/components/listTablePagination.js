...
export default function ListTablePaginationActions(props) {
...
ListTablePaginationActions.propTypes = {
...
// export default ListTablePaginationActions = tablePaginationActions;